...
#pragma warning disable 1718
        ...
        public void Implicit_Conversion_From_String()
        {
            ...
            Assert.AreEqual(a.GetType(), typeof(MultiAddress));
        }
        ...
        public void WithPeerId()
        {
            ...
            Assert.AreEqual($"{ma1}/p2p/{id}", ma1.WithPeerId(id).ToString());
        ...
        public void WithoutPeerId()
        {
            ...
            ma1 = new MultiAddress($"/ip4/127.0.0.1/tcp/4001/ipfs/{id}");
            Assert.AreEqual("/ip4/127.0.0.1/tcp/4001", ma1.WithoutPeerId().ToString());
